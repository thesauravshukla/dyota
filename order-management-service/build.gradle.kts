...
tasks.withType<Test> {
    ...
    // through a docker context rather than /var/run/docker.sock.
    ...
    // docker-java defaults to Docker API 1.32, which Docker Engine 25+ rejects with an
    // opaque HTTP 400. Override with DOCKER_API_VERSION on an older daemon.
