...
import com.dyota.auth.web.dto.ApiError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAuth(AuthServiceException e) {
    ...
    /** Nothing internal leaks to the caller; the detail stays in the logs. */
